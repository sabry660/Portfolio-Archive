...
Ammo().then((Ammo) => {
  ...
  function loadFloydText() {
    ...
    text_loader.load('./src/jsm/Roboto_Regular.json', function (font) {
      ...
      var geometry = new THREE.TextGeometry('Mohamed Sabry', {
        font: font,
        size: 3,
        height: 0.5,
        curveSegments: 12,
  ...
  function loadEngineerText() {
    ...
    text_loader.load('./src/jsm/Roboto_Regular.json', function (font) {
      ...
      var geometry = new THREE.TextGeometry('Front end developer', {
        font: font,
        size: 1.5,
        height: 0.5,
        curveSegments: 20,
  ...
  function start() {
    ...
    createBillboard(-80, 2.5, -70, billboardTextures.wordOfMouthTexture, URL.wordOfMouth, Math.PI * 0.22);

    createBillboard(-45, 2.5, -78, billboardTextures.fluencySprintTexture, URL.fluencySprint, Math.PI * 0.17);

    createBillboardRotated(-17, 1.25, -75, billboardTextures.palestinianStoriesTexture, URL.palestinianStories, Math.PI * 0.15);

    createBillboard(15, 2.5, -70, billboardTextures.catchRecruitmentTexture, URL.catchRecruitment, Math.PI * 0.1);

    createBillboard(50, 2.5, -75, billboardTextures.chuwiTexture, URL.chuwi, Math.PI * 0.05);

    createBillboardRotated(70, 1.25, -60, billboardTextures.dashboardTexture, URL.dashboard, Math.PI * 0.02);

    createBillboard(75, 2.5, -30, billboardTextures.guestPortalTexture, URL.guestPortal, Math.PI * 0.0);

    createBillboardRotated(60, 1.25, 10, billboardTextures.villaMiskTexture, URL.villaMisk, Math.PI * -0.05);

    createBillboard(30, 2.5, 30, billboardTextures.cafeTexture, URL.cafe, Math.PI * -0.1);

    createBillboardRotated(-10, 1.25, 40, billboardTextures.clothesTexture, URL.clothes, Math.PI * -0.15);

    createBillboard(-50, 2.5, 35, billboardTextures.dailyDripTexture, URL.dailyDrip, Math.PI * -0.2);

    createBillboardRotated(-75, 1.25, 20, billboardTextures.voyaTexture, URL.voya, Math.PI * -0.25);

    floydWords(16.2, 1, -20);

    createBox(12, 2, -70, 4, 4, 1, boxTexture.Github, URL.gitHub, 0x000000, true);

    createBox(19, 2, -70, 4, 4, 1, boxTexture.mail, 'mailto:engmohamedsabry925@gmail.com', 0x000000, false);

    floatingLabel(11.875, 4.5, -70, 'Github');
    floatingLabel(18.875, 4.5, -70, 'Email');
